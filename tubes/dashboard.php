...
<div class='dashboard'>
    <div class="dashboard-nav">
        <header><a href="#!" class="menu-toggle"><i class="fas fa-bars"></i></a><a href="#" class="brand-logo"><i
                class="fa-duotone fa-diamond"></i> <span>Movloperz</span></a></header>
        <nav class="dashboard-nav-list"><a href="#" class="dashboard-nav-item"><i class="fas fa-home"></i>
            ...
            <div class='dashboard-nav-dropdown'><a href="#!" class="dashboard-nav-item dashboard-nav-dropdown-toggle"><i
                    class="fas fa-users"></i> Panel Admin </a>
                <div class='dashboard-nav-dropdown-menu'><a href="#" class="dashboard-nav-dropdown-item">Register Account</a><a
                        href="#" class="dashboard-nav-dropdown-item">Registry Genre</a><a
                        href="#"
                        class="dashboard-nav-dropdown-item">Registry Category</a><a
                        href="#" class="dashboard-nav-dropdown-item">Movie List</a><a
                        href="#" class="dashboard-nav-dropdown-item">Comming soon Movie</a></div>
            </div>
            <a href="#" class="dashboard-nav-item"><i class="fas fa-cogs"></i> Project Information </a><a
...
<script src="js/script-das.js"></script>
</body>
</html>
